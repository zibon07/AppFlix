        ...
        <Link to={`/appDetails/${app.id}`}>
            <div className='max-w-[350px] mx-auto bg-white h-[430px] p-2 rounded-2xl hover:scale-105 transition ease-in-out shadow-lg'>
                ...
                <div className='flex justify-between items-center'>
                    <button className='btn text-[#00D390]'><img className='w-5 h-5' src="./icon-downloads.png" alt="" />{app.size}</button>
                    <button className='btn text-[#FF8811]'><img className='w-5 h-5' src="./icon-ratings.png" alt="" />{app.ratingAvg}</button>
                </div>
            </div>
        </Link>
    );
